...
export const REGISTRY: Record<ObjectType, Field[]> = {
  ...
  leuchte: [
    ...
    { key: "wartungszyklus", label: "Wartungszyklus", type: "number" },
    { key: "vorschaltgeraet", label: "Vorschaltgerät", type: "boolean" },
    { key: "wechselvorschaltgeraet", label: "Wechselvorschaltgerät", type: "boolean" },
    { key: "kabeluebergangskasten_sk_ii", label: "Kabelübergangskasten SK II", type: "boolean" },
    { key: "montagefirma_leuchte", label: "Montagefirma", type: "text" },
    { key: "schaltstelle", label: "Schaltstelle", type: "text" },
    { key: "zaehler", label: "Zähler", type: "text" },
    COMMON.monteur,
  ...
  mast: [
    ...
    { key: "verrechnungseinheit", label: "Verrechnungseinheit", type: "text" },
    { key: "revision", label: "Revision", type: "date" },
    { key: "montagefirma", label: "Montagefirma", type: "text" },
    { key: "ist_virtueller_standort", label: "Virtueller Standort", type: "boolean" },
    COMMON.monteur,
    { key: "bemerkungen", label: "Bemerkung", type: "text" },
    COMMON.dokumente,
    COMMON.foto,
