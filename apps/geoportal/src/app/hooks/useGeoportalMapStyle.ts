...
export const useMapStyle = () => {
  const { currentStyle: currentStringStyle, setCurrentStyle: setStringStyle } = usePortalsMapStyle();

  const currentStyle = Object.values(MapStyleKeys).includes(currentStringStyle as MapStyleKeys) 
