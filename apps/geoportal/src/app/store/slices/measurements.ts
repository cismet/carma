...
export const updateMeasurementAreaOfDrawing = (newArea) => {
  return function (dispatch, getState) {
    const state = getState();
...
export const getMeasurementsActiveShapes = (state: RootState) =>
  state.measurements.activeShape;
export const getMeasurementsDeleteAll = (state: RootState) =>
  state.measurements.deleteAll;
export const getMeasurementsDrawingShape = (state: RootState) =>
  state.measurements.drawingShape;
export const getMeasurementsLastActiveShapeBeforeDrawing = (state: RootState) =>
  state.measurements.lastActiveShapeBeforeDrawing;
export const getMeasurementsMapMovingEnd = (state: RootState) =>
  state.measurements.mapMovingEnd;
export const getMeasurementsMode = (state: RootState) =>
  state.measurements.mode;
export const getMeasurementsMoveToShape = (state: RootState) =>
  state.measurements.moveToShape;
export const getMeasurementsShowAll = (state: RootState) =>
  state.measurements.showAll;
export const getMeasurementsShapes = (state: RootState) =>
  state.measurements.shapes;
export const getMeasurementsUpdateShapeToShape = (state: RootState) =>
  state.measurements.updateShape;
export const getMeasurementsUpdateTitleStatus = (state: RootState) =>
  state.measurements.updateTitleStatus;
export const getMeasurementsVisibleShapes = (state: RootState) =>
