...
export const getProjektClusterIconCreatorFunction = ({
  ...
  svgSize?: number;
  colorizer?: (properties: any) => string;
} = {}) => {
  return (cluster) => {
    ...
    const canvasSize = (svgSize / 3.0) * 5.0;
    const background = createElement("svg", {
      width: canvasSize,
      height: canvasSize,
      viewBox: `0 0 ${canvasSize} ${canvasSize}`,
    });

    const innerCircleColor = containsSelection
      ? "rgb(67, 149, 254)"
      : "#ffffff";
    ...
    return L.divIcon({
      ...
      html:
        ...
        new XMLSerializer().serializeToString(background),
