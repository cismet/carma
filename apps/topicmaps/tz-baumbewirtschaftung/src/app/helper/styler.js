...
export const getFeatureStyler = (
  ...
  return (feature) => {
    const color = Color(colorizer(feature.properties));
    const selectedColor = Color("#3A7CEB");
    ...
    const style = {
      radius: 10,
      fillColor: selected ? selectedColor : color,
      color: selected ? selectedColor.darken(0.5) : color.darken(0.5),
      opacity: 1,
      fillOpacity: 0.8,
      // svg,
      // svgSize: canvasSize,
