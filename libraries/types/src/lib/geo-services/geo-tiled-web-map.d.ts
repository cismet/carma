import { Degrees, NumericUnit } from "../units";
...
// explicitly degrees only for compatibility with leaflet and maplibre
// Named differently to avoid conflict with leaflet/leaflet-like LatLngZoom
export type LatLngZoomTyped = {
  latitude: Degrees;
  longitude: Degrees;
