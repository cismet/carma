 ...
 *
 * targetCameraState contains serialized Cesium heading/pitch/roll/fov from previous 3D view.
...
export const transitionToCesium = async (
  ...
  try {
    ...
    // Try to restore camera orientation (range comes from zoom-based position)
