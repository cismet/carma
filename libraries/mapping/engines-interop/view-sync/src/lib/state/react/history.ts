...
import type { HistoryConfig, HistoryEntry, HistoryView } from "../core/types";

// Reuse note:
// The generic ring-buffer primitive already lives in @carma-commons/utils.
// This module stays in view-sync because HistoryEntry/HistoryView are
// view-sync domain contracts. Promote higher-level helpers to commons only
// once a second non-view-sync consumer needs the same API shape.
