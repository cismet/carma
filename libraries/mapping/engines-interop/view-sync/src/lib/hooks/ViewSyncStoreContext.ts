...
export const ViewSyncReduxContext = createContext<
  ReactReduxContextValue<ViewSyncState, UnknownAction> | null
>(null);

export const useViewSyncStoreContextOptional = (): ViewSyncStore | null =>
  useContext(ViewSyncStoreContext);

export const useViewSyncReduxSelector =
  createSelectorHook(ViewSyncReduxContext) as TypedUseSelectorHook<ViewSyncState>;
