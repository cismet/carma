import { Cartesian3, Cartographic, Scene } from "@carma/cesium";

import type { Radians } from "@carma/units/types";
import type { TypedConverter } from "@carma/geo/proj";
import { radToDeg } from "@carma/units/helpers";
import { getOrbitPoint } from "@carma-mapping/engines/cesium/core";

import { getHeadingFromCardinalDirection } from "./orientation-utils";
