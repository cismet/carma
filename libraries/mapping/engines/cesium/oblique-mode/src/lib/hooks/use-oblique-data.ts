...
import { fetchGeoJson, FootprintProperties } from "../utils/footprint-utils";
import { getFootprintCenterPoints } from "../utils/footprint-centerpoints";

import {
  extendObliqueImageRecord,
  mapExtOriArrToRecord,
} from "../utils/oblique-image-record";

import { CardinalDirectionEnum } from "../utils/orientation-utils";
import {
  createRBushByCardinal,
  RBushBySectorBlocks,
} from "../utils/spatial-indexing";
...
export function useObliqueData(
  ...
  converter: TypedConverter,
  offset = 0,
  cameraDirectionMapping: Record<string, Record<string, CardinalDirectionEnum>>,
