...
export type RotationAxisVisualizer = {
  ...
  update: (origin: Cartesian3, upVector: Cartesian3, cameraPosition?: Cartesian3) => void;
...
export const createRotationAxisVisualizer = (
  ...
  const createPolyline = () => {
    ...
    for (let i = 0; i < numSegments; i++) {
      ...
      const startScaled = Cartesian3.multiplyByScalar(_upVector, segmentStart, new Cartesian3());
      const endScaled = Cartesian3.multiplyByScalar(_upVector, segmentEnd, new Cartesian3());
