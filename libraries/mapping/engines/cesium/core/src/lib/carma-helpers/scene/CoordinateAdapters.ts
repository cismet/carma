import type { CssPixelPosition, CssPixels, MetricVector3 } from "@carma-units";
...
export type MetricVector3ToScreenProjector = (
...
export const projectMetricVector3ToScreen = (
  scene: Scene | null,
  coordinate: MetricVector3
): CssPixelPosition | null => {
  return createMetricVector3ToScreenProjector(scene)(coordinate);
};
...
export const createMetricVector3ToScreenProjector = (scene: Scene | null) => {
  const worldPointScratch = new Cartesian3();
  return ((coordinate: MetricVector3): CssPixelPosition | null => {
  ...
  }) satisfies MetricVector3ToScreenProjector;
};
