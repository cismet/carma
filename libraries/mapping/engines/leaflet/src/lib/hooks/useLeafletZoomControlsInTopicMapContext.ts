 ...
 */
export const useLeafletZoomControlsInTopicMapContext = () => {
  console.info(
    "[Deprecation] useLeafletZoomControlsInTopicMapContext is deprecated, pass leaflet instance in useLeafletZoomControls instead."
  );
