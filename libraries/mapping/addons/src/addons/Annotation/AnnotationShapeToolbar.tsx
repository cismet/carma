...
const DRAWING_LABEL =
  "min-w-[0.75rem] text-center text-[13px] font-medium leading-none transition-colors";
const DRAWING_TOOLS =
...
export type AnnotationDrawingEntry = {
  id: string;
  /** what the pill shows, just the number */
  label: string;
  /** what the tooltips and screen readers say */
  name: string;
  active: boolean;
};
            ...
            {onZoomDrawing && (
              <Tooltip title="Auf Zeichnung zoomen" placement="bottom">
                <button
                  ...
                  aria-label={`${entry.name} anzeigen`}
