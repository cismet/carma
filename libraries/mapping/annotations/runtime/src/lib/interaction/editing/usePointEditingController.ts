...
export type UpdatePointAnnotationPositionOptions = {
  treatNextPositionAsOffsetAnchor?: boolean;
};

export const usePointEditingController = (
  ...
  const updatePointAnnotationPositionById = useCallback(
    (
      id: string,
      nextPosition: Cartesian3,
      options?: UpdatePointAnnotationPositionOptions
    ) => {
  ...
  const setPointAnnotationElevationById = useCallback(
    (id: string, elevationMeters: number) => {
      ...
      updatePointAnnotationPositionById(id, nextPosition);
    },
    [annotations, updatePointAnnotationPositionById]
  );
  ...
  const setMoveGizmoPointElevationFromAnnotationId = useCallback(
    (sourcePointId: string) => {
      ...
      updatePointAnnotationPositionById(moveGizmoPointId, nextPosition);
    },
    [moveGizmoPointId, annotations, updatePointAnnotationPositionById]
  );
