...
export type StoredAnnotationGeoJsonFeatureCollection = FeatureCollection<
  Geometry,
...
export const sanitizeAnnotationExportFileSegment = (
...
export const resolveAnnotationExportDescriptor = (
...
export const buildStoredAnnotationGeoJsonFeatureCollection = ({
  annotation,
  coordinates,
}: {
  annotation: StoredAnnotation;
...
export const downloadAnnotationGeoJsonFile = (
  fileName: string,
  featureCollection: StoredAnnotationGeoJsonFeatureCollection | null
) => {
