...
export const usePointMarkerBadges = <
  TPoint extends AnnotationPointMarkerBadgePointLike,
...
>(
  ...
  useMemo<Readonly<Record<string, AnnotationPointMarkerBadge>>>(() => {
    ...
    const comparePointIds = (leftId: string, rightId: string) => {
      ...
      return compareOrderedEntries(leftPoint, rightPoint);
    };
