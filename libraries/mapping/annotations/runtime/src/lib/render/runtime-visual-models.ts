import {
  ...
  areRuntimeCoordinatesEqual,
} from "../utils/runtime-coordinate-equality";
import type {
...
const arePointMarkersEqual = (
  ...
  left.every((point, index) => {
    ...
    return (
      ...
      areRuntimeCoordinatesEqual(point.coordinate, otherPoint.coordinate) &&
...
const areEdgesEqual = (
  ...
  left.every((edge, index) => {
    ...
    return (
      ...
      areRuntimeCoordinateListsEqual(edge.coordinates, otherEdge.coordinates)
    );
  });
...
const arePointLabelsEqual = (
  ...
  left.every((label, index) => {
    ...
    return (
      ...
      areRuntimeCoordinatesEqual(label.coordinate, otherLabel.coordinate) &&
...
const arePolygonFillsEqual = (
  ...
  left.every((fill, index) => {
    ...
    return (
      ...
      areRuntimeCoordinateListsEqual(fill.coordinates, otherFill.coordinates)
    );
  });
