...
import { useNodeChainAnnotations } from "../../../annotation-entries/hooks/use-node-chain-annotation-read-model";
import { findProtectedPolygonCandidateNodeIds } from "../../../interaction/lifecycle/modes/selection-deletion-policy";
import {
  useCollection,
  useSelectionState,
  useSettings,
