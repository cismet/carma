...
import { ANNOTATION_TOOLBAR_HELP_TEXT } from "../../config/annotation-toolbar-help-text";
...
import "../annotation-info-box/info-box.css";
const {
...
} from "./annotation-mode-toolbar.types";
...
const SECONDARY_TOOLBAR_HELP_STORAGE_KEY =
  "carma.annotations.secondary-toolbar-help-collapsed.prototype";
