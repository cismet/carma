...
import type { AnnotationSelectionState } from "../types/annotation-selection.types";
...
} from "../../store/state-update-utils";
import type { RectangleSelectionState } from "./use-rectangle-selection-overlay";
