...
import type { AnnotationPointMarkerBadge } from "../../../render/use-render";
...
} from "./edge-overlay-dom";
import { useDistanceLabelVisualizer } from "../../labels/use-distance-label-visualizer";
