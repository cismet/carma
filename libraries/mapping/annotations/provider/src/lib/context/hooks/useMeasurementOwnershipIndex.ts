...
export const useMeasurementOwnershipIndex = (
  planarMeasurementGroups: readonly PlanarMeasurementGroup[]
) => {
  const {
...
export type MeasurementOwnershipIndex = ReturnType<
  typeof useMeasurementOwnershipIndex
>;
