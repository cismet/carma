...
const MEASUREMENT_CURSOR_OVERLAY_ID = "measurement-candidate-crosshair";
...
export const useMeasurementCursorOverlay = (
  ...
  useEffect(() => {
    addLabelOverlayElement({
      id: MEASUREMENT_CURSOR_OVERLAY_ID,
      zIndex: 22,
      getCanvasPosition: () => {
        if (
          !enabled ||
    ...
    return () => {
      removeLabelOverlayElement(MEASUREMENT_CURSOR_OVERLAY_ID);
    };
  }, [
    addLabelOverlayElement,
    cursorContent,
