...
import { useDistanceRelationEditing } from "./useDistanceRelationEditing";
import { useDistanceRelationInteractions } from "../../render/edge/useDistanceRelationInteractions";
...
type UseAnnotationsEditingInput = {
...
export const useAnnotationsEditing = (
  managedAnnotations: UseAnnotationsEditingInput
  ...
  usePointEditingGizmo(scene, visibleMeasurementsForRendering, moveGizmo, {
    pointRadius,
