...
import type { MeasurementToolType } from "./measurementToolTypes";

export type MeasurementToolManagerContext = {
  modeActive?: boolean;
};

export type MeasurementToolDescriptor = ToolDescriptor<
  MeasurementToolType,
  MeasurementToolManagerContext
>;

export type MeasurementToolManager = ToolManager<
  MeasurementToolType,
  MeasurementToolManagerContext
>;

export const DEFAULT_MEASUREMENT_TOOL_MESSAGES: Readonly<
...
export const resolveMeasurementToolText = (
  key: string,
  dictionary: Readonly<
    Record<string, string>
  > = DEFAULT_MEASUREMENT_TOOL_MESSAGES
): string => dictionary[key] ?? key;

export const defaultMeasurementToolDescriptors: readonly MeasurementToolDescriptor[] =
  [
    {
...
export const createMeasurementToolManager = (
  descriptors: readonly MeasurementToolDescriptor[] = defaultMeasurementToolDescriptors
): MeasurementToolManager => createToolManager(descriptors);

export const measurementToolManager = createMeasurementToolManager();
