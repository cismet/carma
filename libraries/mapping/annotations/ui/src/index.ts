...
export { AnnotationInfoBoxTitleInput } from "./lib/components/AnnotationInfoBoxTitleInput";
export {
  AnnotationsToolbar,
...
export type {
  ...
  AnnotationInfoBoxHelpActionTriggerAlignment,
  AnnotationInfoBoxHelpHeadingItem,
  AnnotationInfoBoxHelpHeadingLevel,
