...
export const annotationInfoBoxVisualDefaults: AnnotationInfoBoxVisualOptions =
  Object.freeze({
    ...
    subtitleContainerClassName: "mb-0 w-full px-2 pt-[0.28em]",
    subtitleTextStyle: {
      color: COLORS_HEX.ACCENT_NEUTRALS,
    },
    subtitleTextClassName: `px-2 text-[${annotationInfoBoxTypographyDefaults.supportFontSizeRem}] leading-[1.1] font-semibold`,
    ...
    titleInputClassName: `min-w-0 w-auto max-w-full appearance-none [field-sizing:content] break-words rounded-[${annotationInfoBoxUiDefaults.borderRadiusRem}] border border-transparent bg-transparent px-0 py-[0.05em] text-[${annotationInfoBoxColorPalette.titleText}]/80 placeholder:text-[${annotationInfoBoxColorPalette.titleText}]/50 focus:bg-[${annotationInfoBoxColorPalette.fieldFocusBackground}] focus:outline focus:outline-2 focus:outline-[${annotationInfoBoxColorPalette.fieldFocusOutline}] ${annotationInfoBoxTypographyDefaults.titleTypographyClassName}`,
