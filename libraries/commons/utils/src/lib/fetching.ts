...
/**
 * @deprecated This module is deprecated. Use @carma-commons/fetching instead.
 * This file exists only for backward compatibility and will be removed in a future version.
 *
 * Please migrate to:
 * import { md5FetchJSON, md5FetchText, fetchJSON } from '@carma-commons/fetching';
 */

let warnedOnce = false;
if (!warnedOnce && typeof console !== "undefined") {
  console.warn(
    "[DEPRECATION WARNING] Importing from @carma-commons/utils/fetching is deprecated. " +
      "Please use @carma-commons/fetching instead. This compatibility layer will be removed in a future version."
  );
  warnedOnce = true;
}
