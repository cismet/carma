...
const TOOL_DEBUG_STORAGE_KEY = "carma.measurements.debug.toolChanges";
const TOOL_DEBUG_GLOBAL_KEY = "__CARMA_MEASUREMENTS_DEBUG_TOOL_CHANGES__";
...
const logToolDebug = (event: string, payload: Record<string, unknown>) => {
  ...
  console.debug(`[MeasurementTools] ${event}`, payload);
};
