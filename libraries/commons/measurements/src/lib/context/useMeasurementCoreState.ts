...
export type MeasurementCoreEntry = {
  id: string;
  name?: string;
  locked?: boolean;
};

export type UseMeasurementCoreStateParams<
  TMode extends string,
  TMeasurement extends MeasurementCoreEntry
> = {
  initialMode: TMode;
...
export type MeasurementCoreState<
  TMode extends string,
  TMeasurement extends MeasurementCoreEntry
> = {
...
export const useMeasurementCoreState = <
  TMode extends string,
  TMeasurement extends MeasurementCoreEntry
>({
  initialMode,
  ...
  isSelectableMeasurementId,
}: UseMeasurementCoreStateParams<TMode, TMeasurement>): MeasurementCoreState<
  TMode,
  TMeasurement
> => {
