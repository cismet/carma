...
- `npx storybook automigrate --config-dir libraries/collaboration/carma-pecher-collab/pecher-collab-submodule/.storybook`

- `npx storybook automigrate --config-dir libraries/collaboration/carma-wuppertal-collab/wuppertal-collab-submodule/.storybook`

- `npx storybook automigrate --config-dir libraries/mapping/carma-map-control-layout/.storybook`

- `npx storybook automigrate --config-dir playgrounds/map-control-playground/.storybook`
