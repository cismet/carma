...
const config = {
  tm: {
    ...
    previewMapPosition: "lat=51.30849778367392&lng=7.2529529926447776&zoom=13",
    ...
    applicationMenuIntroductionMarkdown:
      "Über **Einstellungen** können Sie die Darstellung der Hintergrundkarte und der Wasserstofftankstelle an Ihre Vorlieben anpassen. Wählen Sie **Kompaktanleitung** für detailliertere Bedienungsinformationen und **Urbaner Digitaler Zwilling** für eine Einordnung der Wasserstoff-Tankstellenkarte in das Gesamtsystem des Digitalen Zwillings der Stadt Wuppertal.",
    ...
    minZoom: 5,
    maxZoom: 19,
    addGazetteerElementsPerFeature: true,
    defaultLayerConf: null,
    namedLayers: {
      "rvr-spw2_light-tiles": {
        type: "tiles",
        maxNativeZoom: 20,
        maxZoom: 22,
...
const featureDefaultProperties = {
  color: "#247CE0",
  svgBadgeOld:
  ...
  svgBadge:
    '<?xml version="1.0" encoding="utf-8"?> \r\n <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="500" height="500">\r\n   <rect class="bg-fill" fill="#247CE0" x="0" y="0" rx="82.5" ry="82.5" width="500" height="500"/>\r\n  <path class="fg-fill" fill="#FFFFFF" d="m170.25,477.75c-12.5,0-24-5-32.5-13.5s-13.5-19.75-13.5-32.5,5-24,13.5-32.5,19.75-13.5,32.5-13.5,24,5,32.5,13.5,13.5,19.75,13.5,32.5-5,24-13.5,32.5-19.75,13.5-32.5,13.5h0Zm-17.25-28.5c4.5,4.5,10.5,7.25,17.25,7.25s13-2.75,17.25-7.25c4.5-4.5,7.25-10.75,7.25-17.25s-2.75-13-7.25-17.25c-4.5-4.5-10.5-7.25-17.25-7.25s-12.75,2.75-17.25,7.25-7.25,10.75-7.25,17.25,2.75,12.75,7.25,17.25Z"/>\r\n  <path class="fg-fill" fill="#FFFFFF" d="m377.5,477.75c-12.5,0-24-5-32.5-13.5s-13.5-19.75-13.5-32.5,5-24,13.5-32.5,19.75-13.5,32.5-13.5,24,5,32.5,13.5,13.5,19.75,13.5,32.5-5,24-13.5,32.5-19.75,13.5-32.5,13.5Zm-17.25-28.5c4.5,4.5,10.5,7.25,17.25,7.25s13-2.75,17.25-7.25c4.5-4.5,7.25-10.75,7.25-17.25s-2.75-13-7.25-17.25-10.75-7.25-17.25-7.25-12.75,2.75-17.25,7.25-7.25,10.75-7.25,17.25,2.75,12.75,7.25,17.25Z"/>\r\n  <path class="fg-fill" fill="#FFFFFF" d="m198.75,346.25h211c-1.25-3.5-2.25-7-3.5-10.75-6.25-17.75-12.5-37.75-30.25-41-16.5-3-32.5-4.5-47.75-4.75-23.25-.5-42.25,1.25-48.75,2.5-16.5,3.25-27.75,14-39.5,25.25-3.5,3.5-7.25,6.75-11.25,10.5,0,0-.75.5-.75.75-7.75,5.75-15.5,10.75-23.75,15-1.75.75-3.5,1.75-5.25,2.5h-.25Zm-94,79c-15.25-8.75-20.75-22.25-19.5-38.25,2.25-35.75,36.5-40,87-50.75.5,0,1-.5,1.5-.5,8-1.75,15.5-4.5,23-8s14.5-8,21.25-13.25c3.5-3,7-6.5,10.75-9.75,13.75-13,26.75-25.25,47.75-29.5,7.25-1.5,27.5-3.5,52.25-2.75,16.25.5,34.25,1.75,51.75,5,37.25,6.75,33.5,44.5,60,63.25,7.75,5.5,11.25,8.75,18.5,14.75,32.5,27.5,16,82-17.75,81h0v-5.25c0-17.5-7-33.25-18.5-44.75s-27.25-18.5-44.75-18.5-33.25,7-44.75,18.5-18.5,27.25-18.5,44.75v3.5h-81.75v-3.5c0-17.5-7-33.25-18.5-44.75s-27.25-18.5-44.75-18.5-33.25,7-44.75,18.5c-10.25,10.25-16.75,23.75-18.25,39h-2.25.5l-.25-.25Z"/>\r\n  <path class="fg-fill" fill="#FFFFFF" d="m103.75,223v-83.5c-9.5-.5-14.75.25-17,3.25-2.75,3.25-3.25,9.75-3.25,18.5h0v38h0c0,10.5-6.5,17.5-13.5,20.5-3,1.5-6,1.75-9.5,1.75-3,0-6.5-.5-9.5-2-7.25-3.25-12.75-10-12.75-20.5h.25v-89.75h0c0-4,0-6.75.5-8.75.5-2.75,2-4.75,3.5-7h0l27.5-36.25,10.5,8-17,22.25c4,1,7.75,3,10.25,5.5,3.5,3.5,6,8.75,6,14.75s-2.25,11-6,14.75c-3.5,3.5-8.75,6-14.75,6-2.75,0-5.25-.5-7.75-1.75v72h0c0,4.5,2,7,4.75,8.25,1.5.5,2.75,1,4,1s2.75,0,4-.5c3-1.5,5.25-4,5.25-8.25h0v-38h0c0-11.75,1-20.5,6-27,5.25-6.5,13.25-9.5,27.25-8.25V33.75h31.25v74.5h61.75V33.75h31.25v189.25h-31.25v-82.5h-61.75v82.5h-30.5.5Zm-38.5-120s-3.25-2.25-5.25-2.25-4,1-5.25,2.25-2.25,3.25-2.25,5.25,1,4,2.25,5.25c1.5,1.5,3.25,2.25,5.25,2.25s4-1,5.25-2.25c1.5-1.5,2.25-3.25,2.25-5.25s-1-4-2.25-5.25Z"/>\r\n  <path class="fg-fill" fill="#FFFFFF" d="m289.25,234v16.25h-50c.5-6,2-12,5-17.25,2.75-5.5,8-12.75,15.75-21.5,6.5-7,10-12,11.75-14.5,2-3.5,3.25-7.25,3.25-11s-1-7-2.75-8.75-4-3-7-3c-6.5,0-9.75,4.75-10.25,14.5l-14.5-2c1-9.5,3.25-15.75,7.75-20.25s10-6.5,17-6.5c7.75,0,13.5,2.75,17.5,7.75s6,11,6,17.5c0,3.5-.5,7.25-1.75,10.5s-2.75,7-4.75,10.5-5.5,8-10.5,13.25c-4.75,5.25-7.25,8.5-8.5,10.25s-2.25,3.25-3,4.75h28.25v-.5h.75Z"/>\r\n</svg>',
  svgBadgeDimension: {
    width: "500",
    height: "500",
  },
...
const features = [
  {
    ...
    geometry: {
      type: "Point",
      coordinates: [807372.1434121901, 6675973.310699837],
    },
    properties: {
...
test.describe("generic-topicmap smoke test for hydrogen stations", () => {
  test.beforeEach(async ({ context, page }) => {
    ...
    await context.route("https://ceepr.cismet.de/**", (route) =>
      route.fulfill({
        status: 200,
    ...
    const baseUrl = "/" + "dev/wasserstoff-tankstellenkarte_wuppertal/";

    await context.route(baseUrl + "config.json", (route) =>
      route.fulfill({
        status: 200,
        contentType: "application/json",
    ...
    await context.route(baseUrl + "featureDefaults.json", (route) =>
      route.fulfill({
        status: 200,
        contentType: "application/json",
    ...
    await context.route(baseUrl + "featureDefaultProperties.json", (route) =>
      route.fulfill({
        status: 200,
        contentType: "application/json",
        body: JSON.stringify(featureDefaultProperties),
      })
    );

    await context.route(baseUrl + "infoBoxConfig.json", (route) =>
      route.fulfill({
        status: 200,
        contentType: "application/json",
        body: JSON.stringify(infoBoxCOnfig),
      })
    );

    await context.route(baseUrl + "features.json", (route) =>
      route.fulfill({
        status: 200,
        contentType: "application/json",
