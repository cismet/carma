...
import { getCollabedHelpComponentConfig } from "@carma-collab/pecher/mettmann";
...
function App() {
  ...
  // TODO Adresse bestätigen (Muster Kreis Euskirchen: starkregen@kreis-euskirchen.de)
  const email = "starkregen@kreis-mettmann.de";
  ...
  return (
    <>
      ...
      <HeavyRainHazardMap
        ...
        homeZoom={13}
        homeCenter={[51.2570920530181, 6.96902427549119]}
