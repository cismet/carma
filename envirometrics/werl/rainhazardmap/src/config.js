...
const config = {
  ...
  modelWMS: "https://starkregen-werl.cismet.de/geoserver/wms?SERVICE=WMS",
  ...
  simulations: [
    ...
    },
    {
      ...
      icon: "bitbucket",
      subtitle:
        "Simulation eines einstündigen Starkregens mit 90 Liter/m² Niederschlag (Starkregenindex SRI 11) für das hydrologische Einzugsgebiet der Stadt Werl",
    },
  ],
  backgrounds: [
    {
