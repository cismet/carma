  ...
  let mailToHref =
    ...
    encodeURI(
      `Sehr geehrte Damen und Herren,${br}${br}` +
        `während der benutzung der App ist der untenstehende Fehler aufgetreten: ` +
        `${br}${br}` +
  ...
  return (
    <div
      style={{
        ...
        height: "100%",
        minHeight: "100vh",
        background: "url('/carmamap/images/error.jpg')",
      ...
      <div style={{ marginRight: 25, marginLeft: 25 }}>
        <Row className="show-grid">
          <Col style={{ marginTop: 30 }} xs={12} md={12}>
            ...
            <h2 style={{ color: "white" }}>CarmaMap Wuppertal</h2>
          </Col>
        </Row>
      </div>
      {/* </Container> */}
          ...
          <Button
            ...
            onClick={() => {
              ...
              downloadAnchorNode.setAttribute(
                "download",
                "problemReport.carmamap-wuppertal.txt"
              );
