...
import { FORMAT_LOCALE, formatDegrees } from "@carma/units/helpers";

type AngleFormatterStoryProps = {
  value: number;
...
const REPRESENTATIVE_CASES: readonly RepresentativeCase[] = [
  { label: "zero", value: 0 },
  { label: "acute", value: 12.3456 },
  { label: "negative", value: -13.5 },
  { label: "quarter turn", value: 90 },
  { label: "wrap candidate", value: 370.25 },
...
const FormatterPreview = ({
  ...
  const interactiveOutput = useMemo(
    ...
    [fractionDigits, localLocale, unitSymbol, value]
  );
  ...
  const statusValues = useMemo(
    ...
    [fractionDigits, interactiveOutput, localLocale, unitSymbol, value]
  );
  ...
  return (
    ...
    >
      <div style={{ position: "sticky", top: 0, zIndex: 10 }}>
        <ResponsiveStatusBar label="angle formatter" values={statusValues} />
      </div>
...
type Story = StoryObj<AngleFormatterStoryProps>;
